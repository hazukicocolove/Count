...
#ifndef COUNT_SWIFT_H
#define COUNT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Count",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Count11AppDelegate")
...
SWIFT_CLASS("_TtC5Count13SceneDelegate")
...
SWIFT_CLASS("_TtC5Count14ViewController")
